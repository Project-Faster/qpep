...
//go:generate go2array -nolist -platform darwin -var ConfigIconData -package icons config_icon.png
//go:generate go2array -nolist -platform darwin -var ExitIconData -package icons exit_icon.png
//go:generate go2array -nolist -platform darwin -var RefreshIconData -package icons refresh_icon.png
//go:generate go2array -nolist -platform darwin -var MainIconData -package icons main_icon_mac.png
//go:generate go2array -nolist -platform darwin -var MainIconWaiting -package icons main_icon_waiting_1_mac.png
//go:generate go2array -nolist -platform darwin -var MainIconWaiting2 -package icons main_icon_waiting_2_mac.png
//go:generate go2array -nolist -platform darwin -var MainIconConnected -package icons main_icon_connected_mac.png
